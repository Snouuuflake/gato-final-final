main.out: main.o ai.o estadoTablero.o historial.o grafic.o
	gcc -g -Wall -o main main.o ai.o estadoTablero.o historial.o grafic.o `pkg-config --cflags --libs gtk+-2.0`
